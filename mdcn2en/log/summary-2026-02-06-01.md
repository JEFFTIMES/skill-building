# mdcn2en design + implementation summary (2026-02-06)
...
- `mdcn2en/scripts/extract_cn_blocks.py`
...
- `mdcn2en/scripts/insert_en_blocks.py`
...
- Tests
  - `mdcn2en/tests/test_extract_insert.py` validates extract -> translate -> insert.
  - `mdcn2en/tests/test_append_glossary.py` validates glossary helper behavior.
